	...
	<div class="block-5 bg-1  indent-6">
		<div class="container">
			<div class="row">
					...
					<form id="contact-form" method="POST" action="index.php?uc=listeCr&action=afficherCr">
							<!--========================================================
                        	CONTENT
	=========================================================-->
						...
						<fieldset>
						  <legend align = center> Choisir le compte-rendu à modifier </legend>
							...
							echo '	<center>
									<table class="table">
									<tr> 
									  <th class="tableTH" style="width: 10%;">Matricule</th>
								...
								foreach ($execTableauCR as $unCR)
								{
									...
									echo '<td class="tableTD">'.$unCR['rap_cll_matricule'].'</td>
										  <td class="tableTD">'.$unCR['rap_date_visite'].'</td>
										  <td class="tableTD">'.$unCR['rap_date'].'</td>
										  <td class="tableTD">'.$unCR['rap_bilan'].'</td>
										  <td class="tableTD">'.$unCR['rap_mot_code'].'</td>
										  <td class="tableTD">'.$unCR['rap_pra_num'].'</td>
										  <td class="tableTD"> <a href="index.php?uc=listeCr&action=afficherLeCr&numCr='.$unCR['rap_num'].'&matriculeCr='.$unCR['rap_cll_matricule'].'"> <input type="button" name="Modifier" value = "Modifier" class="btn btn-primary"/></a></td>
										</tr>'; 
