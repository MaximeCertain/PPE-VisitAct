<div id="contentPraSaisir">
	<div class="block-3 bg-1">
		<div class="container">
			<div class="row">
				<form id="contact-form" method="POST" action="index.php?uc=listeCr&action=modifierCr">
					<div class="form-group col-md-6">
						<label>Numéro de compte-rendu</label>
						<input type="text" name="numCR" class="form-control" value="<?php echo $unCR['rap_num']; ?>" readonly>
					</div>
					<div class="form-group col-md-6">
						<label>Saisir votre matricule</label>
						<input type="text" name="matricule" class="form-control" value="<?php echo $unCR['rap_cll_matricule']; ?>" readonly>
					</div>
					<div class="form-group col-md-6">
						<label>Saisir la date de la visite</label>
						<input type="date" name="dateVisite" class="form-control" value="<?php echo $unCR['rap_date_visite']; ?>">
					</div>
					<div class="form-group col-md-6">
						<label>Saisir la date de la rédaction du rapport</label>
						<input type="date" name="dateRapport" class="form-control" value="<?php echo $unCR['rap_date']; ?>">
					</div>
					<div class="form-group">
						<label>Bilan de la visite</label>
						<textarea name="bilanRapport" class="form-control" rows="3"><?php echo $unCR['rap_bilan']; ?></textarea>
					</div>
					<div class="form-group col-md-6">
